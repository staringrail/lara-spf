...
use App\API\v1\Library\CaseInsensitiveUriParser;
use Illuminate\Support\Collection;
use App\API\v1\Library\CaseInsensitiveCollectionOperator;

class CaseInsensitiveDingoQueryMapper extends DingoQueryMapper
{
    public function __construct(Request $request)
    {
        ...
        $this->filters = [];
        $this->uriParser = new CaseInsensitiveUriParser($request);
        $this->filters = $this->uriParser->whereParameters();
    }
    ...
    {
        $this->operator = new CaseInsensitiveCollectionOperator($collection, $this->request);
        $this->prepare();
